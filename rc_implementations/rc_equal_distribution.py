...
class RCEqualDistribution(RecommendationCenter):
    def recommend_charging_station(self, car):
        ...
        for charging_station in self.charging_stations:
            if car.car_number == 1:
                print("ED FREE ", charging_station.charging_station_number, charging_station.get_number_of_free_spots(), charging_station.get_queue_size())
            ...
            if selected_charging_station is None or current_occupation < selected_charging_station_occupation or (current_occupation == selected_charging_station_occupation and two_way_distance < selected_charging_station_two_way_distance):
